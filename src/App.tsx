      ...
      <div className="flex border-b border-slate-100 overflow-x-auto scrollbar-hide">
        ...
        {Object.keys(catalogo).map(cat => (
          <button
            ...
            className={`px-8 py-4 text-sm font-bold transition-all shrink-0 whitespace-nowrap ${activeTab === cat && !showSucursalesAdmin && !showPresupuestos && !showCondicionesAdmin ? 'text-indigo-600 border-b-2 border-indigo-600 bg-indigo-50/30' : 'text-slate-400 hover:text-slate-600'}`}
          >
            {cat}
          </button>
        ))}
